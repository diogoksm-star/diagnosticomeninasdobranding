...
export const quizResults: QuizResult[] = [
  {
    ...
    content: [
      ...
      "Deixa eu te contar uma verdade que quase ninguém fala: A maioria das profissionais que estão invisíveis não está errando na entrega. Está errando no lugar que ocupa na mente do cliente.",
      "Hoje, quando alguém precisa do que você faz, o cérebro dela não lembra de você automaticamente. E quando isso acontece, o jogo vira um só: preço, comparação, dúvida.",
      "Por isso você sente que: precisa explicar demais, precisa provar demais, precisa baixar demais.",
      "Não porque você vale menos. Mas porque o mercado ainda te lê como opção genérica.",
      'O erro comum aqui é tentar sair do invisível fazendo mais: mais conteúdo, mais cursos, mais esforço. Mas invisibilidade não se resolve com volume. Se resolve com clareza de posicionamento.',
  ...
  },
  {
    ...
    content: [
      ...
      "Mas aqui está o ponto crítico: Se o cliente ainda compara, é porque o seu lugar ainda não está claro o suficiente.",
      'No nível "notada", acontece algo perigoso: você começa a ter resultados… mas sente que eles vêm com esforço demais.',
      'Alguns clientes fecham rápido. Outros travam. Outros pedem desconto. E isso gera uma confusão interna: "Será que estou cobrando caro?" "Será que preciso explicar melhor?" "Será que o problema sou eu?"',
      "Não é.",
  ...
  },
  {
    ...
    content: [
      ...
      "Seu resultado mostra algo importante: O mercado já percebe que você não é comum.",
      "O cliente sente diferença. Sente segurança. Sente que com você é diferente.",
      "E por isso: o preço pesa menos, a conversa é mais madura, a decisão é mais consciente.",
